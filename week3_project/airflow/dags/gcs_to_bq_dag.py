...
with DAG(
    ...
    for colour, ds_col in COLOUR_RANGE.items():
        ...
        bigquery_external_table_task = BigQueryCreateExternalTableOperator(
            ...
            table_resource={
                "tableReference": {
                    ...
                    "tableId": f"{colour}_{DATASET}_external_table2",
                },
        ...
        if colour == 'yellow':
            ...
            AS \
            SELECT * FROM {BIGQUERY_DATASET}.{colour}_{DATASET}_external_table2;")
        ...
        if colour == 'green':
            ...
            PARTITION BY DATE({ds_col}) \
            AS \
            SELECT * EXCEPT (ehail_fee) FROM {BIGQUERY_DATASET}.{colour}_{DATASET}_external_table2;")
